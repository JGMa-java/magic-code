package com.jgma.xcode.limiter.aspect;

import com.jgma.xcode.common.RedisConstant;
import com.jgma.xcode.enums.ErrorEnum;
import com.jgma.xcode.execption.ApiException;
import com.jgma.xcode.limiter.ExtraLimiter;
import com.jgma.xcode.limiter.Limit;
import com.jgma.xcode.limiter.annotation.RateLimiter;
import com.jgma.xcode.utils.IpUtil;
...
public class RateLimiterAspect implements ApplicationContextAware {
    ...
    @Pointcut("@annotation(com.jgma.xcode.limiter.annotation.RateLimiter)")
